...
import type { VersionInfo, ScrapingData } from "@/app/page";
...
export default function Sidebar({ nodeId, onClose, onDiscover, onStartScraping, discovering, versions, scrapingData }: Props) {
  ...
  if (nodeId === "bd") return <BrightDataPanel onClose={onClose} scrapingData={scrapingData} />;
...
function BrightDataPanel({ onClose, scrapingData }: { onClose: () => void; scrapingData: ScrapingData }) {
  return (
    <div className="w-[340px] h-full max-h-[680px] border-l overflow-y-auto" style={{ background: "#FAFAFA", borderColor: "#E5E5E5" }}>
      <div className="flex items-center justify-between px-5 py-4 border-b" style={{ borderColor: "#E5E5E5" }}>
