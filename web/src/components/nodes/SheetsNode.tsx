...
export default function SheetsNode({ data }: Props) {
  return (
    <NodeShell>
      <div className="w-[220px] rounded-xl border p-4 cursor-grab active:cursor-grabbing transition-all hover:border-[#555]" style={{ background: "var(--card)", borderColor: "var(--border)" }}>
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex-1">
            <div className="text-md font-medium" style={{ color: "var(--text)" }}>Google Sheets</div>
            <div className="text-sm" style={{ color: "var(--text-dim)" }}>Tender Tracker</div>
          </div>
